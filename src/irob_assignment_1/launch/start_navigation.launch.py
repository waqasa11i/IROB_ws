...
def generate_launch_description():
    ...
    bt_xml_path = os.path.join(bt_navigator_dir, 'behavior_trees', 'navigate_to_pose_w_replanning_and_recovery.xml')
    ...
    print(f"DEBUG: Loading params from: {os.path.join(pkg_irob_assignment_1, 'config', 'navigation.yaml')}")
